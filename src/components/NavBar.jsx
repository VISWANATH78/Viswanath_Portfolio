...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full h-20 px-5 text-white bg-gradient-to-r from-cyan-500 to-blue-500 transparent ">
      <div>
        <h1 className="text-5xl font-signature ml-4">V S Viswanath</h1>
      </div>
